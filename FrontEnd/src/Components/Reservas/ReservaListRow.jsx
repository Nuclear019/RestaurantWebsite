...
export default function ReservaListRow({ reserva, onReservaEliminada }) {
    ...
    const handleVerReserva=(idReserva)=>{
    ...
    return (
        <>
            <tr key={reserva.idReserva} onClick={()=>handleVerReserva(reserva.idReserva)} >
